...
public class MaterialDialog {
    ...
    public MaterialDialog setPositiveButton(int resId, final View.OnClickListener listener) {
        ...
        mPositiveButton.setBackgroundResource(R.drawable.materialdialog_button);
    ...
    public MaterialDialog setNegativeButton(int resId, final View.OnClickListener listener) {
        ...
        mNegativeButton.setBackgroundResource(R.drawable.materialdialog_button);
    ...
    private class Builder {
        ...
        private Builder() {
            ...
            View contv = LayoutInflater.from(mContext).inflate(R.layout.dialog_materialdialog, null);
            contv.setFocusable(true);
            contv.setFocusableInTouchMode(true);

            mAlertDialogWindow.setBackgroundDrawableResource(R.drawable.materialdialog_window);
...
//7
            ...
            mMessageView = (TextView) mAlertDialogWindow.findViewById(R.id.materialdialog_message);
            mButtonLayout = (LinearLayout) mAlertDialogWindow.findViewById(R.id.materialdialog_buttonLayout);
            if (mView != null) {
                LinearLayout linearLayout = (LinearLayout) mAlertDialogWindow.findViewById(R.id.materialdialog_contentView);
            ...
            if (mBackgroundResId != 0) {
                LinearLayout linearLayout = (LinearLayout) mAlertDialogWindow.findViewById(R.id.materialdialog_background);
        ...
        public void setPositiveButton(String text, final View.OnClickListener listener) {
            ...
            button.setBackgroundResource(R.drawable.materialdialog_card);
        ...
        public void setView(View view) {
            LinearLayout l = (LinearLayout) mAlertDialogWindow.findViewById(R.id.materialdialog_contentView);
            l.removeAllViews();
        ...
        public void setContentView(View contentView) {
            ...
            LinearLayout linearLayout = (LinearLayout) mAlertDialogWindow.findViewById(R.id.materialdialog_message_content_view);
